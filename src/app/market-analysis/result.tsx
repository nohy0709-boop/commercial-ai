          ...
          headerLeft: () => (
            <TouchableOpacity
              onPress={() =>
                router.replace({
                  pathname:
                    '/market-analysis/suitability-region',
                  params: {
                    businessName,
                    lclsCode,
                    mclsCode,
                  ...
                  {expanded && (
                    <>
                      ...
                      >
                        ...
                        >
                          현재 지역은 실선, 세종시 다른 지역 평균은 점선으로 비교됩니다.
                        </Text>
...
function ScoreBar({
  ...
  return (
    <View
      style={styles.scoreBarItem}
    >
      <View
        style={styles.scoreBarHeader}
      >
        <Text
